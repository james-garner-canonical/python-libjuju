...
class ModelManagerFacade(Type):
    ...
    async def ChangeModelCredential(self, model_credentials=None) -> ErrorResults:
        """
    ...
    async def CreateModel(
        ...
        reply = await self.rpc(msg)
        return ModelInfo.from_json(reply['response'])

    async def DestroyModels(self, models=None) -> ErrorResults:
        """
    ...
    async def DumpModels(self, entities=None, simplified=None) -> StringResults:
        """
    ...
    async def DumpModelsDB(self, entities=None) -> MapResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return MapResults.from_json(reply['response'])

    async def ListModelSummaries(self, all_=None, user_tag=None) -> ModelSummaryResults:
        """
        ...
        reply = await self.rpc(msg)
        return ModelSummaryResults.from_json(reply['response'])

    async def ListModels(self, tag=None) -> UserModelList:
        """
    ...
    async def ModelDefaultsForClouds(self, entities=None) -> ModelDefaultsResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ModelDefaultsResults.from_json(reply['response'])

    async def ModelInfo(self, entities=None) -> ModelInfoResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ModelInfoResults.from_json(reply['response'])
    ...
    async def ModifyModelAccess(self, changes=None) -> ErrorResults:
        """
    ...
    async def SetModelDefaults(self, config=None) -> ErrorResults:
        """
    ...
    async def UnsetModelDefaults(self, keys=None) -> ErrorResults:
        """
