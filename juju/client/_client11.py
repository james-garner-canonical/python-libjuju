...
class ControllerFacade(Type):
    ...
    schema = {
        ...
        'properties': {
            ...
            'RemoveBlocks': {
                'description': 'RemoveBlocks removes all the '
    ...
    async def AllModels(self) -> UserModelList:
        """
        ...
        return UserModelList.from_json(reply['response'])

    async def CloudSpec(self, entities=None) -> CloudSpecResults:
        """
        ...
        reply = await self.rpc(msg)
        return CloudSpecResults.from_json(reply['response'])

    async def ConfigSet(self, config=None) -> JSONObject:
        """
    ...
    async def ControllerAPIInfoForModels(
        self, entities=None
    ) -> ControllerAPIInfoResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ControllerAPIInfoResults.from_json(reply['response'])

    async def ControllerConfig(self) -> ControllerConfigResult:
        """
        ...
        reply = await self.rpc(msg)
        return ControllerConfigResult.from_json(reply['response'])

    async def ControllerVersion(self) -> ControllerVersionResults:
        """
        ...
        reply = await self.rpc(msg)
        return ControllerVersionResults.from_json(reply['response'])

    async def DashboardConnectionInfo(self) -> DashboardConnectionInfo:
        """
        ...
        reply = await self.rpc(msg)
        return DashboardConnectionInfo.from_json(reply['response'])
    ...
    async def GetCloudSpec(self) -> CloudSpecResult:
        """
        ...
        reply = await self.rpc(msg)
        return CloudSpecResult.from_json(reply['response'])

    async def GetControllerAccess(self, entities=None) -> UserAccessResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return UserAccessResults.from_json(reply['response'])

    async def HostedModelConfigs(self) -> HostedModelConfigsResults:
        """
        ...
        reply = await self.rpc(msg)
        return HostedModelConfigsResults.from_json(reply['response'])

    async def IdentityProviderURL(self) -> StringResult:
        """
    ...
    async def InitiateMigration(self, specs=None) -> InitiateMigrationResults:
        """
        ...
        _params['specs'] = specs
        reply = await self.rpc(msg)
        return InitiateMigrationResults.from_json(reply['response'])

    async def ListBlockedModels(self) -> ModelBlockInfoList:
        """
        ...
        reply = await self.rpc(msg)
        return ModelBlockInfoList.from_json(reply['response'])

    async def ModelConfig(self) -> ModelConfigResults:
        """
        ...
        reply = await self.rpc(msg)
        return ModelConfigResults.from_json(reply['response'])

    async def ModelStatus(self, entities=None) -> ModelStatusResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ModelStatusResults.from_json(reply['response'])

    async def ModifyControllerAccess(self, changes=None) -> ErrorResults:
        """
    ...
    async def MongoVersion(self) -> StringResult:
        """
    ...
    async def RemoveBlocks(self, all_=None) -> JSONObject:
        """
    ...
    async def WatchAllModelSummaries(self) -> SummaryWatcherID:
        """
        ...
        reply = await self.rpc(msg)
        return SummaryWatcherID.from_json(reply['response'])

    async def WatchAllModels(self) -> AllWatcherId:
        """
    ...
    async def WatchCloudSpecsChanges(self, entities=None) -> NotifyWatchResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return NotifyWatchResults.from_json(reply['response'])

    async def WatchModelSummaries(self) -> SummaryWatcherID:
        """
