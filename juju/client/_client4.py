...
class AllModelWatcherFacade(Type):
    ...
    async def Next(self) -> AllWatcherNextResults:
        """
        ...
        return AllWatcherNextResults.from_json(reply['response'])
...
class ApplicationOffersFacade(Type):
    ...
    async def ApplicationOffers(
        self, bakery_version=None, offer_urls=None
    ) -> ApplicationOffersResults:
        """
        ...
        reply = await self.rpc(msg)
        return ApplicationOffersResults.from_json(reply['response'])

    async def DestroyOffers(self, force=None, offer_urls=None) -> ErrorResults:
        """
    ...
    async def FindApplicationOffers(
        self, filters=None
    ) -> QueryApplicationOffersResults:
        """
        ...
        reply = await self.rpc(msg)
        return QueryApplicationOffersResults.from_json(reply['response'])

    async def GetConsumeDetails(
        self, offer_urls=None, user_tag=None
    ) -> ConsumeOfferDetailsResults:
        """
        ...
        reply = await self.rpc(msg)
        return ConsumeOfferDetailsResults.from_json(reply['response'])

    async def ListApplicationOffers(
        self, filters=None
    ) -> QueryApplicationOffersResults:
        """
    ...
    async def ModifyOfferAccess(self, changes=None) -> ErrorResults:
        """
    ...
    async def Offer(self, offers=None) -> ErrorResults:
        """
    ...
    async def RemoteApplicationInfo(
        self, bakery_version=None, offer_urls=None
    ) -> RemoteApplicationInfoResults:
        """
        ...
        _params['offer-urls'] = offer_urls
        reply = await self.rpc(msg)
        return RemoteApplicationInfoResults.from_json(reply['response'])
...
class ModelGenerationFacade(Type):
    ...
    async def AbortBranch(self, branch=None) -> ErrorResult:
        """
    ...
    async def AddBranch(self, branch=None) -> ErrorResult:
        """
    ...
    async def BranchInfo(self, branches=None, detailed=None) -> BranchResults:
        """
        ...
        reply = await self.rpc(msg)
        return BranchResults.from_json(reply['response'])

    async def CommitBranch(self, branch=None) -> IntResult:
        """
        ...
        _params['branch'] = branch
        reply = await self.rpc(msg)
        return IntResult.from_json(reply['response'])

    async def HasActiveBranch(self, branch=None) -> BoolResult:
        """
        ...
        _params['branch'] = branch
        reply = await self.rpc(msg)
        return BoolResult.from_json(reply['response'])

    async def ListCommits(self) -> BranchResults:
        """
    ...
    async def ShowCommit(self, generation_id=None) -> GenerationResult:
        """
        ...
        reply = await self.rpc(msg)
        return GenerationResult.from_json(reply['response'])

    async def TrackBranch(
        self, branch=None, entities=None, num_units=None
    ) -> ErrorResults:
        """
...
class SSHClientFacade(Type):
    ...
    async def AllAddresses(self, entities=None) -> SSHAddressesResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return SSHAddressesResults.from_json(reply['response'])

    async def ModelCredentialForSSH(self) -> CloudSpecResult:
        """
    ...
    async def PrivateAddress(self, entities=None) -> SSHAddressResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return SSHAddressResults.from_json(reply['response'])

    async def Proxy(self) -> SSHProxyResult:
        """
        ...
        reply = await self.rpc(msg)
        return SSHProxyResult.from_json(reply['response'])

    async def PublicAddress(self, entities=None) -> SSHAddressResults:
        """
    ...
    async def PublicKeys(self, entities=None) -> SSHPublicKeysResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return SSHPublicKeysResults.from_json(reply['response'])
