...
class CredentialManagerFacade(Type):
    ...
    async def InvalidateModelCredential(self, reason=None) -> ErrorResult:
        """
...
class FirewallRulesFacade(Type):
    ...
    async def ListFirewallRules(self) -> ListFirewallRulesResults:
        """
        ...
        reply = await self.rpc(msg)
        return ListFirewallRulesResults.from_json(reply['response'])

    async def SetFirewallRules(self, args=None) -> ErrorResults:
        """
...
class ImageMetadataManagerFacade(Type):
    ...
    async def Delete(self, image_ids=None) -> ErrorResults:
        """
    ...
    async def List(
        ...
        reply = await self.rpc(msg)
        return ListCloudImageMetadataResult.from_json(reply['response'])

    async def Save(self, metadata=None) -> ErrorResults:
        """
...
class KeyManagerFacade(Type):
    ...
    async def AddKeys(self, ssh_keys=None, user=None) -> ErrorResults:
        """
    ...
    async def DeleteKeys(self, ssh_keys=None, user=None) -> ErrorResults:
        """
    ...
    async def ImportKeys(self, ssh_keys=None, user=None) -> ErrorResults:
        """
    ...
    async def ListKeys(self, entities=None, mode=None) -> StringsResults:
        """
...
class ModelUpgraderFacade(Type):
    ...
    async def AbortModelUpgrade(self, model_tag=None) -> JSONObject:
        """
    ...
    async def UpgradeModel(
        ...
        reply = await self.rpc(msg)
        return UpgradeModelResult.from_json(reply['response'])
...
class PayloadsFacade(Type):
    ...
    async def List(self, patterns=None) -> PayloadListResults:
        """
        ...
        reply = await self.rpc(msg)
        return PayloadListResults.from_json(reply['response'])
...
class SecretBackendsFacade(Type):
    ...
    async def AddSecretBackends(self, args=None) -> ErrorResults:
        """
    ...
    async def ListSecretBackends(
        self, names=None, reveal=None
    ) -> ListSecretBackendsResults:
        """
        ...
        reply = await self.rpc(msg)
        return ListSecretBackendsResults.from_json(reply['response'])

    async def RemoveSecretBackends(self, args=None) -> ErrorResults:
        """
    ...
    async def UpdateSecretBackends(self, args=None) -> ErrorResults:
        """
