...
class ApplicationFacade(Type):
    ...
    schema = {
        'definitions': {
            ...
            'DeployFromRepositoryArg': {
                ...
                'properties': {
                    ...
                    'AttachStorage': {'items': {'type': 'string'}, 'type': 'array'},
            ...
            'DeployFromRepositoryArgs': {
                ...
                'properties': {
                    'Args': {
                        'items': {'$ref': '#/definitions/DeployFromRepositoryArg'},
                        'type': 'array',
                    }
                },
                'required': ['Args'],
            ...
            'DeployFromRepositoryResult': {
                ...
                'properties': {
                    ...
                    'PendingResourceUploads': {
                        'items': {'$ref': '#/definitions/PendingResourceUpload'},
                        'type': 'array',
                    },
                },
            ...
            'DeployFromRepositoryResults': {
                ...
                'properties': {
                    'Results': {
                        'items': {'$ref': '#/definitions/DeployFromRepositoryResult'},
                        'type': 'array',
                    }
                },
                'required': ['Results'],
        ...
        'properties': {
            ...
            'DeployFromRepository': {
                'description': 'DeployFromRepository '
                'is a one-stop '
                ...
                'returned.',
                'properties': {
                    'Params': {'$ref': '#/definitions/DeployFromRepositoryArgs'},
    ...
    async def AddRelation(self, endpoints=None, via_cidrs=None) -> AddRelationResults:
        """
        ...
        return AddRelationResults.from_json(reply['response'])
    ...
    async def AddUnits(
        ...
        reply = await self.rpc(msg)
        return AddApplicationUnitsResults.from_json(reply['response'])

    async def ApplicationsInfo(self, entities=None) -> ApplicationInfoResults:
        """
        ...
        reply = await self.rpc(msg)
        return ApplicationInfoResults.from_json(reply['response'])

    async def CharmConfig(self, args=None) -> ApplicationGetConfigResults:
        """
        ...
        _params['args'] = args
        reply = await self.rpc(msg)
        return ApplicationGetConfigResults.from_json(reply['response'])

    async def CharmRelations(
        ...
        _params['application'] = application
        reply = await self.rpc(msg)
        return ApplicationCharmRelationsResults.from_json(reply['response'])

    async def Consume(self, args=None) -> ErrorResults:
        """
    ...
    async def Deploy(self, applications=None) -> ErrorResults:
        """
    ...
    async def DeployFromRepository(self, args=None) -> DeployFromRepositoryResults:
        """
        ...
        _params['Args'] = args
        reply = await self.rpc(msg)
        return DeployFromRepositoryResults.from_json(reply['response'])

    async def DestroyApplication(self, applications=None) -> DestroyApplicationResults:
        """
        ...
        _params['applications'] = applications
        reply = await self.rpc(msg)
        return DestroyApplicationResults.from_json(reply['response'])

    async def DestroyConsumedApplications(self, applications=None) -> ErrorResults:
        """
    ...
    async def DestroyUnit(self, units=None) -> DestroyUnitResults:
        """
        ...
        _params['units'] = units
        reply = await self.rpc(msg)
        return DestroyUnitResults.from_json(reply['response'])

    async def Expose(self, application=None, exposed_endpoints=None) -> JSONObject:
        """
    ...
    async def Get(self, application=None, branch=None) -> ApplicationGetResults:
        ...
        reply = await self.rpc(msg)
        return ApplicationGetResults.from_json(reply['response'])

    async def GetCharmURLOrigin(
        self, application=None, branch=None
    ) -> CharmURLOriginResult:
        """
        ...
        _params['branch'] = branch
        reply = await self.rpc(msg)
        return CharmURLOriginResult.from_json(reply['response'])

    async def GetConfig(self, entities=None) -> ApplicationGetConfigResults:
        """
    ...
    async def GetConstraints(self, entities=None) -> ApplicationGetConstraintsResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ApplicationGetConstraintsResults.from_json(reply['response'])

    async def Leader(self, tag=None) -> StringResult:
        """
    ...
    async def MergeBindings(self, args=None) -> ErrorResults:
        """
    ...
    async def ResolveUnitErrors(self, all_=None, retry=None, tags=None) -> ErrorResults:
        """
        ...
        if retry is not None and not isinstance(retry, bool):
            raise TypeError(f'Expected retry to be a bool, received: {type(retry)}')

        if tags is not None and not isinstance(tags, (dict, Entities)):
            raise TypeError(f'Expected tags to be a Entities, received: {type(tags)}')
    ...
    async def ScaleApplications(self, applications=None) -> ScaleApplicationResults:
        """
        ...
        _params['applications'] = applications
        reply = await self.rpc(msg)
        return ScaleApplicationResults.from_json(reply['response'])
    ...
    async def SetConfigs(self, args=None) -> ErrorResults:
        """
    ...
    async def SetConstraints(self, application=None, constraints=None) -> JSONObject:
        """
    ...
    async def SetMetricCredentials(self, creds=None) -> ErrorResults:
        """
    ...
    async def SetRelationsSuspended(self, args=None) -> ErrorResults:
        """
    ...
    async def Unexpose(self, application=None, exposed_endpoints=None) -> JSONObject:
        """
    ...
    async def UnitsInfo(self, entities=None) -> UnitInfoResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return UnitInfoResults.from_json(reply['response'])

    async def UnsetApplicationsConfig(self, args=None) -> ErrorResults:
        """
    ...
    async def UpdateApplicationBase(self, args=None) -> ErrorResults:
        """
