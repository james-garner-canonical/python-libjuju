...
class AdminFacade(Type):
    ...
    async def Login(
        ...
        return LoginResult.from_json(reply['response'])

    async def RedirectInfo(self) -> RedirectInfoResult:
        """
        ...
        reply = await self.rpc(msg)
        return RedirectInfoResult.from_json(reply['response'])
...
class BackupsFacade(Type):
    ...
    async def Create(self, no_download=None, notes=None) -> BackupsMetadataResult:
        """
        ...
        _params['notes'] = notes
        reply = await self.rpc(msg)
        return BackupsMetadataResult.from_json(reply['response'])
...
class ModelConfigFacade(Type):
    ...
    async def GetModelConstraints(self) -> GetConstraintsResults:
        """
        ...
        reply = await self.rpc(msg)
        return GetConstraintsResults.from_json(reply['response'])

    async def ModelGet(self) -> ModelConfigResults:
        """
    ...
    async def ModelSet(self, config=None) -> JSONObject:
        """
    ...
    async def ModelUnset(self, keys=None) -> JSONObject:
        """
    ...
    async def SLALevel(self) -> StringResult:
        """
    ...
    async def Sequences(self) -> ModelSequencesResult:
        """
        ...
        reply = await self.rpc(msg)
        return ModelSequencesResult.from_json(reply['response'])

    async def SetModelConstraints(
        self, application=None, constraints=None
    ) -> JSONObject:
        """
    ...
    async def SetSLALevel(
        self, modelslainfo=None, creds=None, level=None, owner=None
    ) -> JSONObject:
        """
...
class ResourcesFacade(Type):
    ...
    async def AddPendingResources(
        ...
        _params['url'] = url
        reply = await self.rpc(msg)
        return AddPendingResourcesResult.from_json(reply['response'])

    async def ListResources(self, entities=None) -> ResourcesResults:
        """
        ...
        reply = await self.rpc(msg)
        return ResourcesResults.from_json(reply['response'])
...
class UserManagerFacade(Type):
    ...
    async def AddUser(self, users=None) -> AddUserResults:
        """
        ...
        _params['users'] = users
        reply = await self.rpc(msg)
        return AddUserResults.from_json(reply['response'])

    async def DisableUser(self, entities=None) -> ErrorResults:
        """
    ...
    async def EnableUser(self, entities=None) -> ErrorResults:
        """
    ...
    async def ModelUserInfo(self, entities=None) -> ModelUserInfoResults:
        """
        ...
        _params['entities'] = entities
        reply = await self.rpc(msg)
        return ModelUserInfoResults.from_json(reply['response'])

    async def RemoveUser(self, entities=None) -> ErrorResults:
        """
    ...
    async def ResetPassword(self, entities=None) -> AddUserResults:
        """
    ...
    async def SetPassword(self, changes=None) -> ErrorResults:
        """
    ...
    async def UserInfo(self, entities=None, include_disabled=None) -> UserInfoResults:
        """
        ...
        reply = await self.rpc(msg)
        return UserInfoResults.from_json(reply['response'])
